...
class _Socle:
    def __init__(self, anomalies_prio, expl, df, id_cols, target, alpha):
        ...
        # --- y_obs vrai depuis df_model (pas expl) ---
        if "y_obs" in self.ex.columns and target in df.columns:
            jc = [c for c in self.cles if c in df.columns]
...
def configurer_app(app, anomalies_prio, expl, df, id_cols, target,
    ...
    app.layout = html.Div(
        ...
        children=[
            ...
            dcc.Markdown(_bandeau(
                "<b>Identifications des observations Atypiques</b>",
            ...
            dcc.Markdown(_bandeau(
                "<b>Conformal Prediction Intervalle</b>",
            ...
            dcc.Markdown(_bandeau(
                "<b>Historique de l'observation</b>",
            ...
            dcc.Markdown(_bandeau(
                ...
                fond="#fce4ec", coul="#880e4f"), dangerously_allow_html=True),
            html.Div(fig_vars,
                     style={"background": "#fff", "borderRadius": "10px",
                            "boxShadow": _OMBRE_CARTE, "padding": "8px",
                            "marginBottom": "10px"}),
